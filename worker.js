...
var api = new ParseServer({
  ...
  appId: process.env.WORKER_APP_ID || 'app',
  masterKey: process.env.MASTER_KEY || '',
  serverURL: process.env.WORKER_SERVER_URL || 'http://localhost:1338/parse',
  verbose: false,
  loggerAdapter: {
...
var dashboard = new ParseDashboard({
  "apps": [
    {
      "serverURL": process.env.WORKER_SERVER_URL || 'http://localhost:1337/parse',
      "appId": process.env.WORKER_APP_ID || 'app',
      "masterKey": process.env.MASTER_KEY || '',
